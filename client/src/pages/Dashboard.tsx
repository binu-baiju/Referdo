...
// import jwt from "jsonwebtoken";
type User = { name: string; email: string; _id: string; profession: string };
const Dashboard: React.FC = () => {
  const [user, setUser] = useState<User>({name:"",email:"",_id:"",profession:""});
      ...
      <div className="bg-purple-400  text-white h-[500px] rounded-md w-80 shadow-md drop-shadow-2xl align-center mt-14">
        ...
        <div className="flex flex-col">
          ...
          <div>
            {/* <button
              type="button"
              className="text-white bg-yellow-400  text-[8px] mt-2"
            >
              Edit Profile
            </button> */}
            <label
              htmlFor="my-modal-3"
              className="btn text-white bg-yellow-400  text-[8px] mt-2"
            >
              open modal
            </label>
          </div>
        ...
        <div className="w-90 h-40 bg-blue-900 rounded-lg shadow-md absolute inset-x-5 bottom-28">
          <div className="w-60 h-10 bg-purple-400 rounded-lg ml-5 mt-2 ">
            <div>
              <button
                type="button"
                className="text-white bg-yellow-400 ml-40 text-[8px]"
              >
                Show
              </button>
            </div>
